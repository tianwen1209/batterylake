/* ══════════════════════════════════════════════════════════════
   CONFIG
   ══════════════════════════════════════════════════════════════ */
const GITHUB_CSV_URL = new URL('dataset_registry.csv', document.baseURI).href;

/* ══════════════════════════════════════════════════════════════
   FALLBACK DATA — used when GitHub fetch fails (e.g. offline / CORS)
   ══════════════════════════════════════════════════════════════ */
const FALLBACK_DATASETS = [
  { id:'dataset_01', name:'NASA PCoE Battery Aging', ref_name:'2007_NASA_PCoE_LCO_18650_1C_1C_25T', status:'done', category:'cycle_aging', chemistry:'LCO', cells:'34', form:'18650', cycles:5609, size_mb:209.70867, notes:'4 LCO 18650 cells; 7.28M timeseries rows; charge/discharge/impedance', doi:'https://data.nasa.gov', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgAu2ccBNe8cT5AV0bDy1ePxAX-As6pYSo1z1kyM4LRB3nI?e=TwNiSM', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 34 cell .mat files (B0005-B0056) in the complete NASA archive; 5,609 cycles from the ETL summary. Volume: Complete NASA source ZIP; verified archive receipt.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_02', name:'CALCE CS2 Battery Aging', ref_name:'2013_CALCE_UMD_LCO_Prismatic_1.1Ah_0.5C_1C_25T', status:'done', category:'cycle_aging', chemistry:'LCO', cells:'6', form:'Prismatic', cycles:5686, size_mb:248.444385, notes:'CS2/CX2 LCO 18650; Excel format; 1000+ cycles', doi:'https://calce.umd.edu', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCPAOqTpPscT7YfIS1HgMPAAZHMsg6r2tsFwWfzysV9fVI?e=mCG0yb', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): the CS2 study is the six CS2_33-CS2_38 cells (all archives held); 5,686 source cycle indices across their 152 cycling tables. Volume: All six author CS2_33 through CS2_38 ZIP archives; complete CS2 release, not the entire CALCE portal.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_03', name:'Stanford-MIT-TRI Fast Charging', ref_name:'2019_Stanford_MIT_TRI_LFP_18650_MultiC_30T', status:'done', category:'cycle_aging', chemistry:'LFP', cells:'124', form:'18650', cycles:0, size_mb:8269.341808, notes:'124 LFP/graphite cells; multi-protocol fast charging; Severson et al. Nature Energy 2019', doi:'https://doi.org/10.1038/s41560-019-0356-8', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgD_pp7pwJmGSo8YoIWsyUhsAdAXebc_hy7v3wYg_xPVqro?e=gfzBXe', evidence:'Full-source metrics audit 2026-09-08. Complete-study cell count retained from author documentation. Earlier estimated cycle total removed pending a complete source-cycle audit. Volume: All three original 2017-05, 2017-06, 2018-04 MATR batch files; upstream HEAD lengths. Later 2019 extension excluded.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'known' },
  { id:'dataset_04', name:'Oxford Battery Degradation', ref_name:'2017_Oxford_Howey_LCO-NCO_Pouch_740mAh_2C_Artemis_40T', status:'wip', category:'cycle_aging', chemistry:'Multi', cells:'8', form:'Pouch', cycles:55300, size_mb:266.236883, notes:'Oxford Dataset 1; eight Kokam pouch cells. Full source scope excludes unrelated NCA studies.', doi:'https://ora.ox.ac.uk/objects/uuid:03ba4b01-cfed-46d3-9b1a-7d4a7bdf6fac', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBs5CWjO_9qS5DrwYGebQHBAaZIyqPvyWjtC9m31o_tC3k?e=yRITtW', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 8 Kokam pouch cells in Oxford Battery Degradation Dataset 1 (complete); cycles = sum of the last RPT aging-cycle count per cell, RPT every 100 cycles (55,300). Volume: Complete Oxford Dataset 1 MAT plus ExampleDC MAT; accompanying documentation excluded.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_05', name:'RWTH Aachen Lithium-Ion', ref_name:'2021_RWTH_Aachen_NMC_18650_MultiC_MultiT', status:'done', category:'cycle_aging', chemistry:'NMC', cells:'48', form:'18650', cycles:116749, size_mb:5444.154862, notes:'RWTH Aachen; NMC/Graphite; CSV format; 48 samples', doi:'https://publications.rwth-aachen.de/record/818642', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgA6E_29GYFTSqvUREUnC4oEAShTAGsl4lNqEkm1LcM7h2Y?e=awyBsa', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 48 Sanyo UR18650E cells per the RWTH metadata PDF; 116,749 aging cycles counted as distinct Zyklus counter values across the ZYK cycling files (complete 5.1 GB archive held). Volume: Complete author Rawdata.zip; accompanying documentation excluded.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_06', name:'SNL BatteryArchive Cycle Aging', ref_name:'2020_SNL_BatteryArchive_NCA-NMC-LFP_18650_MultiDOD_MultiC_15-25-35T', category:'cycle_aging', chemistry:'NCA-NMC-LFP', form:'18650', cells:'61', cycles:0, size_mb:0, status:'wip', doi:'https://zenodo.org/records/21149533', processed_url:'', notes:'Preger et al. JES 2020 cycle aging. BatteryLife v12 processed copy; original BatteryArchive CSV not acquired. Mechanical abuse is dataset_34.', meta:'yes', ts:'yes', cs:'yes', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'unknown', evidence:'Full-source metrics audit 2026-09-08. 61 cells in the documented SNL BatteryLife release; original CSV volume and full original cycle count unavailable. The processed-copy ZIP size is excluded. Volume: Full original release volume is unknown; local subset, processed-copy and unverified legacy sizes are excluded.' },
  { id:'dataset_07', name:'HNEI BatteryArchive NMC', ref_name:'2018_HNEI_BatteryArchive_NMC-LCO_18650_2.8Ah_0.5C_1.5C_25T', status:'done', category:'cycle_aging', chemistry:'NMC', cells:'14', form:'18650', cycles:0, size_mb:0, notes:'Hawaii Natural Energy Institute; NMC 18650 cells', doi:'https://batteryarchive.org', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgAe8XQyoi2BSLmMrf42Xz4lASO3fAf88CfQ-zHAE8AkgJU?e=iw69hJ', evidence:'Full-source metrics audit 2026-09-08. 14 HNEI study cells. Original CSV volume and full original cycle total are not established by the BatteryLife copy; processed-copy size/cycles excluded. Volume: Full original release volume is unknown; local subset, processed-copy and unverified legacy sizes are excluded.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'unknown' },
  { id:'dataset_08', name:'UL-Purdue BatteryArchive NCA', ref_name:'2020_UL_PUR_BatteryArchive_NCA_18650_0.5C_0.5C_23T', status:'done', category:'cycle_aging', chemistry:'NCA', cells:'21', form:'18650', cycles:0, size_mb:0, notes:'UL-PUR / UL-Purdue; 21 NCA 18650 cylindrical cells; 23°C; 0.5C/0.5C protocol', doi:'https://batteryarchive.org', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCk2QLkD7maSYcV51CbnSS6Adf5rpq85Y9nW75acvkODzI?e=LtTELj', evidence:'Full-source metrics audit 2026-09-08. 21 cells in the original UL-PUR Part I study (BatteryArchive study summary); the local BatteryLife copy covers only 10. Original CSV volume and complete cycle total unknown. Volume: Full original release volume is unknown; local subset, processed-copy and unverified legacy sizes are excluded.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'unknown' },
  { id:'dataset_09', name:'XJTU NCM Prismatic', ref_name:'2024_XJTU_NCM_18650_2Ah_MultiC_MultiC_25T', status:'done', category:'cycle_aging', chemistry:'NMC', cells:'55', form:'18650', cycles:27642, size_mb:2438.769934, notes:'Xi\'an Jiaotong University; NCM prismatic; Zenodo 2023', doi:'https://zenodo.org/records/10963339', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCZBnB6O9HAQI-TxUwXTAcMAbNRt2oC9C9TDAkT-4Q1rmE?e=jCPdVs', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 55 LISHEN NCM 18650 cells in 6 batches per the XJTU data introduction; 27,642 cycles counted from the 55 complete .mat files. Volume: Complete author Battery Dataset.zip, Zenodo 10963339; official size and MD5.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_11', name:'KIT NMC/C-SiO 228 Cells', ref_name:'2024_KIT_NMC-SiO_18650_MultiC_MultiT', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'228', form:'18650', cycles:0, size_mb:69375.563264, notes:'Karlsruhe Institute; 228 NMC/C-SiO cells; 30B+ data points; Sci Data 2024', doi:'https://doi.org/10.1038/s41597-024-03831-x', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgA7SW3-O8n1SIVDxKOIv3OxAVZY3b8ZY7Mqmu2xGl934HQ?e=SYqOzt', evidence:'Full-source metrics audit 2026-09-08. 228 cells in the original KIT study; raw release volume comes from the full upstream record. Volume: Official RADAR v1 record contentSize; the local mixed v1/v2 subset is not used.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'known', cells_group:'KIT_Luh_228' },
  { id:'dataset_12', name:'Tsinghua Li-ion EV Field', ref_name:'2022_Tsinghua_LiIon_EV_MultiChem_MultiC_MultiT', status:'pending', category:'ev', chemistry:'Multi', cells:'464 EVs', form:'EV-BMS', cycles:0, size_mb:1408.209405, notes:'Tsinghua University; real-world EV battery cycle data', doi:'https://data.mendeley.com/datasets/mcsh4hnb8b/1', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCWAMpPvIFGSoFxZoh4ltkdARgWCDSfpiOUSa2yYdr6kC8?e=dxi7lb', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 464 vehicles across the three complete tar.gz archives (native charging snippets). Volume: Complete official file manifest captured 2026-09-08; author release files only.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'not_applicable', cycles_basis:'unknown', volume_basis:'known' },
  { id:'dataset_13', name:'Comprehensive battery aging dataset for NMC/C-SiO cells', ref_name:'2024_KIT_Luh_NMC_18650_MultiC_MultiC_MultiT', status:'pending', category:'field_data', chemistry:'NMC', cells:'228', form:'18650', cycles:0, size_mb:81909.759488, notes:'3 billion data points; 228 commercial NMC/C+SiO lithium-ion cells; aged for almost 600 days', doi:'https://radar.kit.edu/radar/en/dataset/kww7jv8ajuvchcah#', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCviM4fNJhJR5eUQr46kGU4AXinAKoE6AGOFG1lxbY2f68?e=29gQzN', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'known', cells_group:'KIT_Luh_228', evidence:'Full-source metrics audit 2026-09-08. 228 study cells shared with dataset_11; one cell-count group prevents counting these twice. Volume: Official RADAR v2 log release contentSize; full release, not the selected local logs.' },
  { id:'dataset_14', name:'Stanford High-Power Cell Characterization', ref_name:'2025_Stanford_Onori_NMC_21700_Molicel-P42A_MultiC_MultiT', status:'pending', category:'characterization', chemistry:'NMC', cells:'45', form:'21700', cycles:0, size_mb:2745.069193, notes:'45 Molicel P42A cells; high-power characterization and stochastic modeling; author OSF archive.', doi:'https://osf.io/9ceav/', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCzM5vwbXzVQZlE57pKF-fZASJ4dH12luElFQBRM2-eogU?e=qnjXxJ', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08. 45 cells in the author high-power Molicel P42A study, Scientific Data DOI 10.1038/s41597-025-05725-y. Characterization tests are not aging-cycle totals. Volume: Complete author Dataset_Molicell_P42A.zip from OSF; expanded copies excluded.' },
  { id:'dataset_15', name:'IVST Changan Large-Scale NEV', ref_name:'2023_IVST_Changan_LiIon_EV_MultiChem_MultiC_MultiT', status:'pending', category:'field_data', chemistry:'Multi', cells:'—', form:'EV-BMS', cycles:0, size_mb:74306.376155, notes:'IVST/Changan; real-world large-scale NEV Li-ion battery dataset', doi:'http://ivstskl.changan.com.cn/?p=2697', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCY47Rn2592R4QabVItC3L8AXjbpHJHI59SUVsWErLxQSA?e=gfZeVM', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): upstream release is stated as 74.3 GB of vehicle records; only a 0.1 GB sample archive is held locally, so no vehicle count is claimed. Volume: Complete upstream RAW_DATA.z01 + RAW_DATA.zip split archive; public share manifest. Local sample excluded.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'not_applicable', cycles_basis:'unknown', volume_basis:'known' },
  { id:'dataset_16', name:'TBSI-Lijing Pulse Voltage', ref_name:'2024_TBSI_Lijing_LiIon_Retired_PulseVoltage_MultiT', status:'pending', category:'soh_estimation', chemistry:'Multi', cells:'464', form:'Multi', cycles:0, size_mb:14409.915853, notes:'TBSI & Lijing; retired batteries; pulse voltage response', doi:'https://zenodo.org/records/13360631', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBYcPYztbIYTapaaIao6BqHAZZLZxeAfZZMwmKkuNbaaTA?e=SFT0ii', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 464 retired cell IDs in the author pulse-feature tables (4,628 pulse samples), complete release; no cycle axis. Volume: Complete official file manifest captured 2026-09-08; author release files only.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'not_applicable', volume_basis:'known' },
  { id:'dataset_17', name:'A123 LFP HEV-WLTP Drive Cycle', ref_name:'2021_A123_LFP_18650_2.5Ah_HEV-WLTP_25T', status:'pending', category:'cycle_aging', chemistry:'LFP', cells:'3', form:'18650', cycles:0, size_mb:3373.184626, notes:'A123 2.5Ah LFP 18650; HEV WLTP drive cycle; SOH 15-70%', doi:'https://borealisdata.ca/dataset.xhtml?persistentId=doi:10.5683/SP3/23MFNE', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCXoroka133RpfJ32DUNCZAAVafbxgTDzoXOze9LVdWEdk?e=xi8U33', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 3 A123 2.5 Ah cells (95k / 206k / 300k km cases), complete release; drive-cycle aging has no simple cycle count. Volume: All three author drive-history ZIPs plus original summary XLSX; ingested TAB not counted again.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'known' },
  { id:'dataset_18', name:'A123 LFP Calendar+Cycle 50°C', ref_name:'2022_A123_LFP_18650_1.1Ah_CalCyc_50T', status:'pending', category:'cycle_aging', chemistry:'LFP', cells:'20', form:'18650', cycles:82600, size_mb:26298.87975, notes:'20× A123 LFP 18650 1.1Ah; calendar + cycle aging at 50°C', doi:'https://entrepot.recherche.data.gouv.fr/dataset.xhtml?persistentId=doi:10.57745/OLBXKT', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBpRY44AYW3Qayk7hCi38G5AZB-ogUecwQ-VdBexMVgOmU?e=wkHvCs', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 20 A123 18650 cells (all 20 cell archives held); cycles = sum of the last RPT aging-cycle count per cell (82,600). Volume: Complete set of author source ZIP archives; no extracted or converted files.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_19', name:'Oxford Path-Dependent Degradation', ref_name:'2020_Oxford_Howey_LiIon_PathDep_MultiC_MultiT', status:'pending', category:'cycle_aging', chemistry:'Multi', cells:'28', form:'Multi', cycles:0, size_mb:8950.273323, notes:'Oxford Howey group; 3-part path-dependent degradation dataset', doi:'https://ora.ox.ac.uk/objects/uuid:de62b5d2-6154-426d-bcbb-30253ddb7d1e', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgAP3unusCzYTJafZgLbW-NQAUjOh4ieMtAtYmzfrTNzrW0?e=NSScEL', evidence:'Full-source metrics audit 2026-09-08. Complete-study cell count retained from author documentation. Earlier estimated cycle total removed pending a complete source-cycle audit. Volume: Complete Parts 1-3 ZIP payloads, including EIS and half-cell files; accompanying guides excluded.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'known' },
  { id:'dataset_20', name:'Mendeley Drive Cycle Multi-Chem', ref_name:'2021_Mendeley_LFP-NCA-NMC_18650_DriveCycle_MultiT', status:'pending', category:'characterization', chemistry:'Multi', cells:'—', form:'18650', cycles:0, size_mb:102.805962, notes:'LFP+NCA+NMC; DST/FUDS/UDDS/WLTP/US06 drive cycles; 4 temps', doi:'https://data.mendeley.com/datasets/29kw38kzwj/1', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCG4BbE2uK4Qo83K8yJHrsxAfBMciPWuE5YPshAhvgFH2c?e=y7EawZ', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'unknown', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08.  Volume: Complete official file manifest captured 2026-09-08; author release files only.' },
  { id:'dataset_21', name:'CMU VTC6 eVTOL Duty Cycle', ref_name:'2023_CMU_Bills_NMC_18650_VTC6_eVTOL_25T', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'22', form:'18650', cycles:21392, size_mb:1539.394976, notes:'Carnegie Mellon Bills group; Sony-Murata VTC6; eVTOL duty cycle; Nat Sci Data 2023', doi:'https://figshare.com/articles/dataset/eVTOL_Battery_Dataset/14226830', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDFu5H98Ti8QY8PrtyveawVAUWZLQ3wdhl0DCimDEi5ejU?e=Jokp4v', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 22 cells (VAH01-VAH30) in the complete figshare release; 21,392 cycles as reported for the dataset. The tester cycleNumber in the files is not accurate (7,139 distinct values). Volume: Complete Figshare version 3 official file list; original release files only.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_22', name:'EVERLASTING 4TU (25°C+45°C)', ref_name:'2022_EVERLASTING_4TU_NMC-SiGr_18650_3.5Ah_MultiC_25-45T', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'17', form:'18650', cycles:0, size_mb:9134.458452, notes:'EU EVERLASTING; Ni-rich Si/Gr 3.5Ah 18650; multi C-rate at 25°C & 45°C', doi:'https://data.4tu.nl/datasets/e19fe272-4f46-450c-9125-6545c4c1a98b', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgC5NJyK0KTKQ64QWk8NUmInASWVj_BBUcMn_ktr3HUle7o?e=E9OSWh', evidence:'Full-source metrics audit 2026-09-08. Corrected 4TU cycling release e19fe272, same as dataset_23. 17 author per-cell CSVs; calendar record e42bca59 is a different study and is not counted here. Volume: Complete corrected 4TU e19fe272 author file list (17 cell CSVs + README); same source under IDs 22/23, counted once.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'known', cells_group:'EVERLASTING_e19fe272', cycles_group:'EVERLASTING_e19fe272', volume_group:'EVERLASTING_e19fe272' },
  { id:'dataset_23', name:'EVERLASTING 4TU (25°C+45°C)', ref_name:'2022_EVERLASTING_4TU_NMC_18650_3.5Ah_MultiC_25-45T', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'17', form:'18650', cycles:0, size_mb:9134.458452, notes:'EU EVERLASTING; Ni-rich Si/Gr 3.5Ah 18650; multi C-rate at 25°C & 45°C', doi:'https://data.4tu.nl/datasets/e19fe272-4f46-450c-9125-6545c4c1a98b', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDMnm7IbveySa0cehfkpl5tATGVmgHqrangERU5J547JLY?e=dVSwJF', evidence:'Full-source metrics audit 2026-09-08. 17 cell identities in the complete author file list; the previous count of 18 included a README. Shared release with dataset_22. Volume: Complete corrected 4TU e19fe272 author file list (17 cell CSVs + README); same source under IDs 22/23, counted once.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'known', cells_group:'EVERLASTING_e19fe272', cycles_group:'EVERLASTING_e19fe272', volume_group:'EVERLASTING_e19fe272' },
  { id:'dataset_24', name:'Stanford-Onori Galvanostatic Discharge', ref_name:'2021_Stanford_Onori_NMC-NCA-LFP_18650_MultiC_MultiT', status:'pending', category:'characterization', chemistry:'Multi', cells:'—', form:'18650', cycles:0, size_mb:638.231736, notes:'Stanford Onori Lab; NMC+NCA+LFP 18650; multi-rate multi-temp galvanostatic', doi:'https://data.mendeley.com/datasets/kxsbr4x3j2/2', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgC9kAYKGaOkTp-kP56gqRdgAa1iNwCzcF0Epne1cQ_bjkc?e=YYpklI', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'unknown', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08.  Volume: Complete official file manifest captured 2026-09-08; author release files only.' },
  { id:'dataset_25', name:'Stanford-Onori EV Real-Driving', ref_name:'2022_Stanford_Onori_NMC_Cyl_RealDriving_MultiT', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'10', form:'Cyl', cycles:0, size_mb:0, notes:'Stanford Onori Lab; NMC cells; real EV driving profile aging', doi:'https://osf.io/qsabn/', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDTdOwzyY70QpcENz78IPHYAdo6GZASgoVgbbzH1WLKpYM?e=TbPxYs', evidence:'Full-source metrics audit 2026-09-08. 10 original LG INR21700-M50T cells; original UDDS full cycle count and full release size remain unknown while source traversal is incomplete. Volume: Full original release volume is unknown; local subset, processed-copy and unverified legacy sizes are excluded.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'unknown', cells_group:'Onori_first_second_life' },
  { id:'dataset_26', name:'Stanford-Onori Parallel Cells', ref_name:'2024_Stanford_Onori_LiIon_Parallel_MultiC_25T', status:'pending', category:'characterization', chemistry:'Multi', cells:'—', form:'18650', cycles:0, size_mb:762.469662, notes:'Stanford Onori Lab; parallel-connected Li-ion; cell-to-cell imbalance', doi:'https://data.mendeley.com/datasets/zh58byr53c/1', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCFLHnq6CLRQIlTdsmmOiVoAWE7LmUEp57XuHie5bpSdLw?e=AQhtTc', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'unknown', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08.  Volume: Complete official file manifest captured 2026-09-08; author release files only.' },
  { id:'dataset_27', name:'Stanford-Onori Second-Life Grid', ref_name:'2024_Stanford_Onori_LiIon_SecondLife_GridStorage_25T', status:'pending', category:'cycle_aging', chemistry:'Multi', cells:'6', form:'Multi', cycles:0, size_mb:2153.883052, notes:'Stanford Onori Lab; second-life Li-ion grid storage cycling aging', doi:'https://osf.io/8jnr5/', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgA97EpKF88jS7lxt8eZa2T8AWuN18p0SabzbDtkbftF5g8?e=Nt7BWI', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'known', cells_group:'Onori_first_second_life', evidence:'Full-source metrics audit 2026-09-08. Six second-life cells in the author paper DOI 10.1016/j.dib.2024.111046, continued from the ten-cell first-life dataset_25; same physical-cell group. Volume: Complete author second-life ZIP from OSF root listing; not the partial legacy local folder.' },
  { id:'dataset_28', name:'Stanford-Onori LFP SOC ML', ref_name:'2024_Stanford_Onori_LFP_Cyl_SOC-ML_25T', status:'pending', category:'soc_estimation', chemistry:'LFP', cells:'—', form:'Cyl', cycles:0, size_mb:2419.728427, notes:'Stanford Onori Lab; LFP; coulomb counting + ML SOC estimation', doi:'https://github.com/LeXuSECL/ML_SOC_Estimation_ACS_Energy_Letters', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDnvOSEcdVgSZS5sfWSLF_CAeOK4rRPvdgW8obpwV9YVr0?e=4a3J2w', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'unknown', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08.  Volume: Complete author GitHub archive at pinned commit 8855592; not an extracted folder.' },
  { id:'dataset_29', name:'Stanford-SLAC Decade Calendar Aging', ref_name:'2025_Stanford_Chueh_MultiChem_Calendar_MultiT', status:'pending', category:'calendar_aging', chemistry:'Multi', cells:'259', form:'Multi', cycles:0, size_mb:850.754705, notes:'259 source cell IDs; 232 included in the paper analysis. Author raw and summary archives; 13-year calendar aging study.', doi:'https://osf.io/ju325/', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBqu1mPtw4hRbGcJpxnMxohAesvvTCFjojoGpkj0xa3ttI?e=fDVCd7', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08. 259 distinct Cell_id entries in the author Joule_cell_id.csv, including 27 cells excluded from paper analysis (232 analyzed). Count the original release, not the analysis subset. Volume: Complete official file manifest captured 2026-09-08; author release files only.' },
  { id:'dataset_30', name:'Beihang EV Fault Diagnosis', ref_name:'2025_Beihang_LiIon_EV-BMS_MultiChem_MultiT', status:'pending', category:'field_fault_diagnosis', chemistry:'Multi', cells:'515 EVs', form:'EV-BMS', cycles:0, size_mb:38100, notes:'Beihang Univ; 515 real EVs; 18.2M BMS entries; 3 manufacturers; fault labels TR/EL/ISC/EA; Nat Commun 2025', doi:'https://doi.org/10.5281/zenodo.10656500', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBa8Ai0y8C0R5gx4SvlkYYcAYfIEjg5VrrRzDY8ZR_Z_yg?e=5hgc3i', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'not_applicable', cycles_basis:'unknown', volume_basis:'author_rounded', evidence:'Full-source metrics audit 2026-09-08.  Volume: Author Zenodo 10656500 full seven-archive listing: 38.1 GB (rounded). GIS/DTI local subset is not used.' },
  { id:'dataset_31', name:'Mendeley NMC811-LFP Relaxation', ref_name:'2023_Mendeley_NMC811-LFP_18650_Relaxation_MultiT', status:'pending', category:'eis', chemistry:'Multi', cells:'—', form:'18650', cycles:0, size_mb:1292.019622, notes:'Auxiliary physical dataset: relaxation/rest voltage; NMC811+LFP; SOH estimation reference', doi:'https://data.mendeley.com/datasets/y8nstxmdrg/1', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgA-px8bByeZTZ6e6LK94owSAchC3h0mGXL0s9hy6KoAFS4?e=REJLlF', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'unknown', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08.  Volume: Complete official file manifest captured 2026-09-08; author release files only.' },
  { id:'dataset_32', name:'Figshare LFP Pouch EIS', ref_name:'2023_Figshare_LFP_Pouch_0.6Ah_EIS_MultiT', status:'pending', category:'eis', chemistry:'LFP', cells:'—', form:'Pouch', cycles:0, size_mb:0.465799, notes:'Auxiliary physical dataset: EIS frequency sweep; 600 mAh LFP pouch; impedance spectra', doi:'https://figshare.com/articles/dataset/Li-ion_Batteries_EIS_measurements/23736582', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgC7krq2n_GqS6g3JYOsFbj3ARyxru8g_dwgn8woHVVEmUM?e=KhufHX', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'unknown', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08.  Volume: Complete Figshare version 1 official file list; original release files only.' },
  { id:'dataset_33', name:'TUM Thermal Runaway Propagation', ref_name:'2023_TUM_NMC811-LFP_Auto_ThermalRunaway_MultiT', status:'pending', category:'thermal_runaway', chemistry:'Multi', cells:'—', form:'Auto', cycles:0, size_mb:841.320832, notes:'Auxiliary physical dataset: thermal runaway propagation; NMC-811+LFP automotive modules', doi:'https://mediatum.ub.tum.de/node?id=1717758', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCOGktuuuDqSYXNk9xVkk62AdHPq7VHsekMzDC2kOEqgZU?e=lv9vSC', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'unknown', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08.  Volume: Every file in the complete author FTP checksum list verified against upstream SHA-512; sum of matched original file bytes.' },
  { id:'dataset_34', name:'Mendeley Mech-Induced Thermal Runaway', ref_name:'2023_Mendeley_LiIon_MechAbuse_NailPenetration_MultiT', status:'pending', category:'thermal_runaway', chemistry:'Unknown', cells:'109', form:'Multi', cycles:0, size_mb:292.28331, notes:'Auxiliary physical dataset: mechanical abuse / nail penetration; thermal runaway trigger', doi:'https://data.mendeley.com/datasets/sn2kv34r4h/2', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBxqo5F5qKwQbH--4jPp3IpASRJpR9OyMGEu1SUu4mLSLw?e=Lhdp6u', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08. 54 ORNL + 55 SNL pouch cells in the author mechanical-abuse study, as described by BatteryArchive; 109 total, no cycling axis. Volume: Complete official file manifest captured 2026-09-08; author release files only.' },
  { id:'dataset_35', name:'Zenodo ARC Calorimetry 21700', ref_name:'2023_Zenodo_NMC-NCA-LFP_21700_ARC_Calorimetry_MultiT', status:'pending', category:'thermal_runaway', chemistry:'Multi', cells:'55 specimens', form:'21700', cycles:0, size_mb:0.22814, notes:'Auxiliary physical dataset: ARC exothermal; 21700; NMC/NCA/LFP; thermal safety', doi:'https://zenodo.org/records/7707929', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBB_0fSJ5MXSbhmHVeJK6LyAYVORNLdvhuyyXT_3CkhohU?e=ONxPU5', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 55 ARC test specimens (complete release); cycling does not apply. Volume: Complete official file manifest captured 2026-09-08; author release files only.', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'not_applicable', cycles_basis:'not_applicable', volume_basis:'known' },
  { id:'dataset_36', name:'Imperial College 21700 Cycle Aging', ref_name:'2024_Imperial_Kirkaldy_NMC_21700_MultiC_MultiT', status:'done', category:'cycle_aging', chemistry:'NMC', cells:'40', form:'21700', cycles:131301, size_mb:49420.596739, notes:'LG M50T/GBM50T 21700; 3 temps; J. Power Sources 2024', doi:'https://doi.org/10.5281/zenodo.10637534', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDFoGTyCAf7SokvWt55BZl9AXaoMW8HTT1L1p22T4Gc5zo?e=ReCV3T', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 40 cells across the five experiments in experiment_metadata.xlsx (9 + 6 + 9 + 8 + 8); 131,301 aging cycles summed from the per-cell "Summary per Cycle" tables (complete 46 GB release held). Volume: Complete five author experiment ZIP archives; metadata workbook excluded.', meta:'yes', ts:'yes', cs:'yes', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_37', name:'Munich Multistage Aging Samsung 21700', ref_name:'2024_TUM_Stroebl_NMC_21700_Multistage_25T', status:'done', category:'cycle_aging', chemistry:'NMC', cells:'279', form:'21700', cycles:0, size_mb:10292.649424, notes:'279× Samsung INR21700-50E; 71 aging conditions; Scientific Data 2024', doi:'https://figshare.com/articles/dataset/Multi-Stage_Lithium_Ion_Battery_Aging_Study/25975315', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCKqhLB3FILTZSucxlDhPw2AYsFXXGONKTHfQT09Xa-15Y?e=hVhwOD', evidence:'Full-source metrics audit 2026-09-08. Complete-study cell count retained from author documentation. Earlier estimated cycle total removed pending a complete source-cycle audit. Volume: Complete Figshare version 1 official file list; original release files only.', meta:'yes', ts:'yes', cs:'yes', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'unknown', volume_basis:'known' },
  { id:'dataset_38', name:'ISU-ILCC Battery Aging', ref_name:'2023_ISU_ILCC_Thelen_NMC_Pouch_MultiC_30T', status:'done', category:'cycle_aging', chemistry:'NMC', cells:'251', form:'Pouch', cycles:1331994, size_mb:11186.085527, notes:'Iowa State Univ; 251 NMC/graphite 250 mAh pouch cells; 63 cycling conditions at 30C; C/5 and C/2 RPTs', doi:'https://iastate.figshare.com/articles/dataset/_b_ISU-ILCC_Battery_Aging_Dataset_b_/22582234', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgAQsqg5Eb4SSZDw_owj_-m6AcXA90yjg98xig61jAwtCzk?e=Rld0C3', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 251 NMC/graphite 502030 pouch cells under 63 conditions per README_V2.0.pdf (complete 10.4 GB release held; the earlier LFP/cylindrical label was wrong); 1,331,994 partial-DoD cycles counted from the per-cell Cycling_json capacity records. Volume: Complete Figshare version 2 official file list; original release files only.', meta:'yes', ts:'yes', cs:'yes', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_39', name:'CQU Battery Aging', ref_name:'2023_CQU_NCA-LFP_Pouch-Prismatic_MultiC_MultiT', status:'done', category:'cycle_aging', chemistry:'NCA-LFP', cells:'47', form:'Pouch', cycles:104817, size_mb:272.160209, notes:'Diverse Pouch & Prismatic cells; Multi-temperature & dynamic loading profiles; complex cycle aging', doi:'https://data.mendeley.com/datasets/n3b54nsw8m/9', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCKZCKUHq78SY57RhoFxXrtAaVz7wEc_OY1q007gmfSp_4?e=OIYo61', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 47 cells across three MAT files covering four experiments (30 source cell names, namespaced per file); 104,817 cycle records. Volume: Complete three author MAT files covering experiments 1-4; not four physical files.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_40', name:'THI Experimental Calendar Ageing', ref_name:'2022_THI_Geisbauer_MultiChem_Calendar_3SOC_50-60T', category:'calendar_aging', chemistry:'NCA/NMC/LFP/LCO/LMO/LTO-LCO', form:'Multi', cells:'108', cycles:0, size_mb:0.079545, status:'wip', doi:'https://zenodo.org/records/6685365', processed_url:'', notes:'THI calendar capacity summaries; downloaded v3 tables contain SOC 20/50/100%, 50/60 C and 0-152 days. CSV/XLSX/TAB are alternative representations; no raw waveforms; not JRC.', meta:'yes', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'not_applicable', volume_basis:'known', evidence:'Full-source metrics audit 2026-09-08. 108 distinct (chemistry, Cell Identity Number) keys across the six original CSV tables; alternate CSV/XLSX/TAB formats counted once. Calendar RPT observations are not aging cycles. Volume: Complete author Zenodo v3 ZIP (18 source files in three representations); counted once.' },
  { id:'dataset_41', name:'HUST Cycle Aging', ref_name:'2022_HUST_LFP_18650_MultiC_MultiC_30T', status:'done', category:'cycle_aging', chemistry:'LFP', cells:'77', form:'18650', cycles:146122, size_mb:1188.136932, notes:'72 LFP/Graphite cells; Multi-stage fast charging profiles; early-life cycle aging', doi:'https://data.mendeley.com/datasets/nsc7hnsg4s/2', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBGu5W7qVaoQrqxK__aZVxJASOx3Dvpm_Asln6aoOF5-n8?e=tTppur', evidence:'Full-source metrics audit 2026-09-08. Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 77 LFP/graphite cells per the Mendeley v2 description (complete release held); 146,122 per-cycle curve files. Volume: Complete author our_data.zip release; metadata documents excluded.', meta:'yes', ts:'yes', cs:'yes', qc:'yes', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'known' },
  { id:'dataset_eee', name:'NTU Ampace-Samsung 21700', ref_name:'2026_NTU_Ampace-Samsung_LFP-NMC_21700_2C_2C_25T', status:'done', category:'cycle_aging', chemistry:'Multi', cells:'16', form:'21700', cycles:9095, size_mb:251.65824, notes:'NTU; Ampace 21700A + Samsung 35E; 16 cells; 9,095 cycles', doi:'', processed_url:'', meta:'yes', ts:'yes', cs:'yes', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'known', cycles_basis:'known', volume_basis:'legacy_reported', evidence:'Full-source metrics audit 2026-09-08.  Volume: Internal complete-experiment catalog reports 240 MiB (converted to decimal MB); original precision retained as reported.' },
  { id:'dataset_internal_MSE', name:'NTU Internal Battery Dataset', ref_name:'2026_NTU_Internal_LFP-NCA_MultiForm_MultiC_MultiT', status:'done', category:'cycle_aging', chemistry:'Multi', cells:'—', form:'Multi', cycles:0, size_mb:0, notes:'NTU internal dataset; LFP/NCA cells; OneDrive shared internal access', doi:'', processed_url:'', meta:'yes', ts:'yes', cs:'yes', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'unknown', cycles_basis:'unknown', volume_basis:'unknown', evidence:'Full-source metrics audit 2026-09-08.  Volume: Full original release volume is unknown; local subset, processed-copy and unverified legacy sizes are excluded.' },
  { id:'dataset_internal', name:'BatteryLake Internal Experiment', ref_name:'TBD_NTU_Internal_LiIon_TBD_TBD_TBD', status:'pending', category:'cycle_aging', chemistry:'Unknown', cells:'—', form:'—', cycles:0, size_mb:0, notes:'Internal experiment data; to be provided by supervisor', doi:'', processed_url:'', student:'TBD', meta:'no', ts:'no', cs:'no', qc:'no', updated:'2026/9/8', stats_scope:'full_source', cells_basis:'unknown', cycles_basis:'unknown', volume_basis:'unknown', evidence:'Full-source metrics audit 2026-09-08.  Volume: Full original release volume is unknown; local subset, processed-copy and unverified legacy sizes are excluded.' },
];
...
function lookupProcessedUrl(id, refName, csvUrl) {
  const fromCsv = (csvUrl || '').trim();
  if (fromCsv.startsWith('http')) return fromCsv;
  const byId = FALLBACK_DATASETS.find(d => d.id === id);
  if (byId && byId.processed_url) return byId.processed_url;
  const byRef = FALLBACK_DATASETS.find(d => d.ref_name && d.ref_name === refName);
  if (byRef && byRef.processed_url) return byRef.processed_url;
  return '';
}
...
function csvRowToDataset(row) {
  ...
  return applyDatasetCategoryOverride({
    ...
    cycles, size_mb,
    stats_scope: (row.stats_scope || 'unverified').trim(),
    cells_basis: (row.cells_basis || 'unknown').trim(),
    cycles_basis: (row.cycles_basis || 'unknown').trim(),
    volume_basis: (row.volume_basis || 'unknown').trim(),
    cells_group: (row.cells_group || '').trim(),
    cycles_group: (row.cycles_group || '').trim(),
    volume_group: (row.volume_group || '').trim(),
    doi, processed_url, student,
    evidence: (row.count_basis || '').trim(),
...
/* Aggregate the full original releases, independently of local acquisition.
   Hidden internal entries remain included. Known shared cells / identical
   releases contribute once; unknown or unverified totals never become zeros
   masquerading as measurements. See docs/HOME_METRICS.md. */
function computeHomeMetrics() {
  const all = DATASETS;
  const num = v => Number(v) || 0;
  const cellsOf = d => /^[\d,]+$/.test(String(d.cells || '').trim()) ? num(String(d.cells).replace(/,/g, '')) : 0;
  ...
  const aggregate = (basis, group, value) => {
    const groups = new Map();
    let unknown = 0;
    for (const d of all) {
      if (d.stats_scope !== 'full_source' || !['known', 'author_rounded', 'legacy_reported'].includes(d[basis])) {
        if (d[basis] !== 'not_applicable') unknown++;
        continue;
      }
      const key = d[group] || d.id;
      groups.set(key, Math.max(groups.get(key) || 0, value(d)));
    }
    return { total: [...groups.values()].reduce((a, b) => a + b, 0), unknown };
  };
  const cycles = aggregate('cycles_basis', 'cycles_group', d => num(d.cycles));
  const cells = aggregate('cells_basis', 'cells_group', cellsOf);
  const volume = aggregate('volume_basis', 'volume_group', d => num(d.size_mb));
  return {
    ...
    cycles: cycles.total,
    cells: cells.total,
    volumeGB: volume.total / 1000,
    unknown: { cycles: cycles.unknown, cells: cells.unknown, volume: volume.unknown }
  };
}
window.computeHomeMetrics = computeHomeMetrics;

function formatCyclesMetric(cycles) {
  if (cycles >= 1000000) return (cycles / 1000000).toFixed(2) + '<span class="metric-unit">M</span>';
...
function formatCellsStat(cells) {
  const str = String(cells || '').trim();
  const m = str.match(/^([\d,.]+)\s*(.*)$/);
  if (!m) return `<span class="stat-val">${esc(str)}</span>`;
  const unit = m[2] ? m[2] : 'cells';
  return `<span class="stat-val">${esc(m[1])}</span> ${esc(unit)}`;
}
function datasetCardHTML(d) {
  ...
  const cyclesFmt = cyclesNum > 0
    ...
    : null;
  const title = (d.ref_name && d.ref_name !== '—') ? d.ref_name : d.name;
  const subtitle = (d.ref_name && d.ref_name !== '—' && d.name && d.name !== d.ref_name) ? d.name : '';
  const cardTags = [
  ...
  return `
    <div class="dataset-card" onclick="openDatasetModal('${escAttr(d.id)}')">
      <div class="dc-top">
        ...
        <div class="dc-body">
          <div class="dc-name">${esc(title)}</div>
          ${subtitle ? `<div class="dc-refname">${esc(subtitle)}</div>` : ''}
        </div>
      </div>
      <div class="dc-stats">
        ${d.cells && d.cells !== '—' && d.cells !== '-' ? `<span class="dc-stat">
          ...
          ${formatCellsStat(d.cells)}
        </span>` : ''}
        ${d.form && d.form !== '—' ? `<span class="dc-stat">
...
function bwFlowRenderDatasets() {
  ...
  if (!box) return;
  // refreshAll() runs during init, before the Benchmarks flow state below is created.
  if (typeof BWR === 'undefined' || !BWR) return;
