...
const FALLBACK_DATASETS = [
  { id:'dataset_01', name:'NASA PCoE Battery Aging', ref_name:'2007_NASA_PCoE_LCO_18650_1C_1C_25T', status:'done', category:'cycle_aging', chemistry:'LCO', cells:'34', form:'18650', cycles:5609, size_mb:205, notes:'4 LCO 18650 cells; 7.28M timeseries rows; charge/discharge/impedance', doi:'https://data.nasa.gov', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgAu2ccBNe8cT5AV0bDy1ePxAX-As6pYSo1z1kyM4LRB3nI?e=TwNiSM', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 34 cell .mat files (B0005-B0056) in the complete NASA archive; 5,609 cycles from the ETL summary.', meta:'yes',ts:'yes',cs:'yes',qc:'yes',updated:'2026/3/18'},
  { id:'dataset_02', name:'CALCE CS2 Battery Aging', ref_name:'2013_CALCE_UMD_LCO_18650_0.5C_1C_25T', status:'done', category:'cycle_aging', chemistry:'LCO', cells:'6', form:'18650', cycles:5686, size_mb:236, notes:'CS2/CX2 LCO 18650; Excel format; 1000+ cycles', doi:'https://calce.umd.edu', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCPAOqTpPscT7YfIS1HgMPAAZHMsg6r2tsFwWfzysV9fVI?e=mCG0yb', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): the CS2 study is the six CS2_33-CS2_38 cells (all archives held); 5,686 source cycle indices across their 152 cycling tables.', meta:'yes',ts:'yes',cs:'yes',qc:'yes',updated:'2026/3/18'},
  ...
  { id:'dataset_11', name:'KIT NMC/C-SiO 228 Cells', ref_name:'2024_KIT_NMC-SiO_18650_MultiC_MultiT', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'228', form:'18650', cycles:0, size_mb:5519, notes:'Karlsruhe Institute; 228 NMC/C-SiO cells; 30B+ data points; Sci Data 2024', doi:'https://doi.org/10.1038/s41597-024-03831-x', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgA7SW3-O8n1SIVDxKOIv3OxAVZY3b8ZY7Mqmu2xGl934HQ?e=SYqOzt', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 228 cells per the KIT release; the local copy (5.4 GB) holds the v2 result tables plus part of the v1 raw logs, so the volume is a lower bound.', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_12', name:'Tsinghua Li-ion EV Field', ref_name:'2022_Tsinghua_LiIon_EV_MultiChem_MultiC_MultiT', status:'pending', category:'ev', chemistry:'Multi', cells:'464 EVs', form:'EV-BMS', cycles:0, size_mb:1341, notes:'Tsinghua University; real-world EV battery cycle data', doi:'https://data.mendeley.com/datasets/mcsh4hnb8b/1', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCWAMpPvIFGSoFxZoh4ltkdARgWCDSfpiOUSa2yYdr6kC8?e=dxi7lb', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 464 vehicles across the three complete tar.gz archives (native charging snippets).', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  ...
  { id:'dataset_15', name:'IVST Changan Large-Scale NEV', ref_name:'2023_IVST_Changan_LiIon_EV_MultiChem_MultiC_MultiT', status:'pending', category:'field_data', chemistry:'Multi', cells:'—', form:'EV-BMS', cycles:0, size_mb:76083, notes:'IVST/Changan; real-world large-scale NEV Li-ion battery dataset', doi:'http://ivstskl.changan.com.cn/?p=2697', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCY47Rn2592R4QabVItC3L8AXjbpHJHI59SUVsWErLxQSA?e=gfZeVM', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): upstream release is stated as 74.3 GB of vehicle records; only a 0.1 GB sample archive is held locally, so no vehicle count is claimed.', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_16', name:'TBSI-Lijing Pulse Voltage', ref_name:'2024_TBSI_Lijing_LiIon_Retired_PulseVoltage_MultiT', status:'pending', category:'soh_estimation', chemistry:'Multi', cells:'464', form:'Multi', cycles:0, size_mb:13742, notes:'TBSI & Lijing; retired batteries; pulse voltage response', doi:'https://zenodo.org/records/13360631', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBYcPYztbIYTapaaIao6BqHAZZLZxeAfZZMwmKkuNbaaTA?e=SFT0ii', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 464 retired cell IDs in the author pulse-feature tables (4,628 pulse samples), complete release; no cycle axis.', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_17', name:'A123 LFP HEV-WLTP Drive Cycle', ref_name:'2021_A123_LFP_18650_2.5Ah_HEV-WLTP_25T', status:'pending', category:'cycle_aging', chemistry:'LFP', cells:'3', form:'18650', cycles:0, size_mb:3215, notes:'A123 2.5Ah LFP 18650; HEV WLTP drive cycle; SOH 15-70%', doi:'https://borealisdata.ca/dataset.xhtml?persistentId=doi:10.5683/SP3/23MFNE', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCXoroka133RpfJ32DUNCZAAVafbxgTDzoXOze9LVdWEdk?e=xi8U33', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 3 A123 2.5 Ah cells (95k / 206k / 300k km cases), complete release; drive-cycle aging has no simple cycle count.', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_18', name:'A123 LFP Calendar+Cycle 50°C', ref_name:'2022_A123_LFP_18650_1.1Ah_CalCyc_50T', status:'pending', category:'cycle_aging', chemistry:'LFP', cells:'20', form:'18650', cycles:82600, size_mb:25078, notes:'20× A123 LFP 18650 1.1Ah; calendar + cycle aging at 50°C', doi:'https://entrepot.recherche.data.gouv.fr/dataset.xhtml?persistentId=doi:10.57745/OLBXKT	', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBpRY44AYW3Qayk7hCi38G5AZB-ogUecwQ-VdBexMVgOmU?e=wkHvCs', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 20 A123 18650 cells (all 20 cell archives held); cycles = sum of the last RPT aging-cycle count per cell (82,600).', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_19', name:'Oxford Path-Dependent Degradation', ref_name:'2020_Oxford_Howey_LiIon_PathDep_MultiC_MultiT', status:'pending', category:'cycle_aging', chemistry:'Multi', cells:'28', form:'Multi', cycles:20400, size_mb:8540, notes:'Oxford Howey group; 3-part path-dependent degradation dataset', doi:'https://ora.ox.ac.uk/objects/uuid:de62b5d2-6154-426d-bcbb-30253ddb7d1e', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgAP3unusCzYTJafZgLbW-NQAUjOh4ieMtAtYmzfrTNzrW0?e=NSScEL', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): Parts 1-3 of the Oxford path-dependent study: 16 cells (groups 1-6) plus 12 cells (groups 7-10); aging cycles approximated as last RPT index x 48 cycles per cell (20,400).', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_20', name:'Mendeley Drive Cycle Multi-Chem', ref_name:'2021_Mendeley_LFP-NCA-NMC_18650_DriveCycle_MultiT', status:'pending', category:'characterization', chemistry:'Multi', cells:'—', form:'18650', cycles:0, size_mb:102, notes:'LFP+NCA+NMC; DST/FUDS/UDDS/WLTP/US06 drive cycles; 4 temps', doi:'https://data.mendeley.com/datasets/29kw38kzwj/1', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCG4BbE2uK4Qo83K8yJHrsxAfBMciPWuE5YPshAhvgFH2c?e=y7EawZ', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_21', name:'CMU VTC6 eVTOL Duty Cycle', ref_name:'2023_CMU_Bills_NMC_18650_VTC6_eVTOL_25T', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'22', form:'18650', cycles:21392, size_mb:1464, notes:'Carnegie Mellon Bills group; Sony-Murata VTC6; eVTOL duty cycle; Nat Sci Data 2023', doi:'https://figshare.com/articles/dataset/eVTOL_Battery_Dataset/14226830', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDFu5H98Ti8QY8PrtyveawVAUWZLQ3wdhl0DCimDEi5ejU?e=Jokp4v', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 22 cells (VAH01-VAH30) in the complete figshare release; 21,392 cycles as reported for the dataset. The tester cycleNumber in the files is not accurate (7,139 distinct values).', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_22', name:'EVERLASTING 4TU (25°C+45°C)', ref_name:'2022_EVERLASTING_4TU_NMC-SiGr_18650_3.5Ah_MultiC_25-45T ', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'17', form:'18650', cycles:0, size_mb:8714, notes:'EU EVERLASTING; Ni-rich Si/Gr 3.5Ah 18650; multi C-rate at 25°C & 45°C', doi:'https://data.4tu.nl/datasets/e42bca59-f1dd-495a-92c9-8b01d6b64040', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgC5NJyK0KTKQ64QWk8NUmInASWVj_BBUcMn_ktr3HUle7o?e=E9OSWh', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 17 per-cell CSV files, the complete corrected 4TU cycling/driving record (Cell63-Cell91).', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_23', name:'EVERLASTING 4TU (25°C+45°C)', ref_name:'2022_EVERLASTING_4TU_NMC_18650_3.5Ah_MultiC_25-45T', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'18', form:'18650', cycles:0, size_mb:9288, notes:'EU EVERLASTING; Ni-rich Si/Gr 3.5Ah 18650; multi C-rate at 25°C & 45°C', doi:'https://data.4tu.nl/datasets/e19fe272-4f46-450c-9125-6545c4c1a98b', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDMnm7IbveySa0cehfkpl5tATGVmgHqrangERU5J547JLY?e=dVSwJF', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 18 per-cell CSV files in the complete 4TU release.', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_24', name:'Stanford-Onori Galvanostatic Discharge', ref_name:'2021_Stanford_Onori_NMC-NCA-LFP_18650_MultiC_MultiT', status:'pending', category:'characterization', chemistry:'Multi', cells:'—', form:'18650', cycles:0, size_mb:604, notes:'Stanford Onori Lab; NMC+NCA+LFP 18650; multi-rate multi-temp galvanostatic', doi:'https://data.mendeley.com/datasets/kxsbr4x3j2/2', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgC9kAYKGaOkTp-kP56gqRdgAa1iNwCzcF0Epne1cQ_bjkc?e=YYpklI', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_25', name:'Stanford-Onori EV Real-Driving', ref_name:'2022_Stanford_Onori_NMC_Cyl_RealDriving_MultiT', status:'pending', category:'cycle_aging', chemistry:'NMC', cells:'10', form:'Cyl', cycles:0, size_mb:2284, notes:'Stanford Onori Lab; NMC cells; real EV driving profile aging', doi:'https://osf.io/qsabn/', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDTdOwzyY70QpcENz78IPHYAdo6GZASgoVgbbzH1WLKpYM?e=TbPxYs', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 10 LG INR21700-M50T cells (capacity/HPPC companion files cover 10 cells); the local OSF copy (2.2 GB) is a partial subset, so no cycle count is claimed.', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_26', name:'Stanford-Onori Parallel Cells', ref_name:'2024_Stanford_Onori_LiIon_Parallel_MultiC_25T', status:'pending', category:'characterization', chemistry:'Multi', cells:'—', form:'18650', cycles:0, size_mb:727, notes:'Stanford Onori Lab; parallel-connected Li-ion; cell-to-cell imbalance', doi:'https://data.mendeley.com/datasets/zh58byr53c/1', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCFLHnq6CLRQIlTdsmmOiVoAWE7LmUEp57XuHie5bpSdLw?e=AQhtTc', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_27', name:'Stanford-Onori Second-Life Grid', ref_name:'2024_Stanford_Onori_LiIon_SecondLife_GridStorage_25T', status:'pending', category:'cycle_aging', chemistry:'Multi', cells:'—', form:'Multi', cycles:0, size_mb:2058, notes:'Stanford Onori Lab; second-life Li-ion grid storage cycling aging', doi:'https://osf.io/8jnr5/', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgA97EpKF88jS7lxt8eZa2T8AWuN18p0SabzbDtkbftF5g8?e=Nt7BWI', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_28', name:'Stanford-Onori LFP SOC ML', ref_name:'2024_Stanford_Onori_LFP_Cyl_SOC-ML_25T', status:'pending', category:'soc_estimation', chemistry:'LFP', cells:'—', form:'Cyl', cycles:0, size_mb:2304, notes:'Stanford Onori Lab; LFP; coulomb counting + ML SOC estimation', doi:'https://github.com/LeXuSECL/ML_SOC_Estimation_ACS_Energy_Letters', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDnvOSEcdVgSZS5sfWSLF_CAeOK4rRPvdgW8obpwV9YVr0?e=4a3J2w', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_29', name:'Stanford-Onori Calendar Aging', ref_name:'2025_Stanford_Onori_LiIon_Calendar_MultiT', status:'pending', category:'calendar_aging', chemistry:'Multi', cells:'—', form:'Multi', cycles:0, size_mb:4659, notes:'Stanford Onori Lab; Li-ion calendar aging; decade-long; Lam et al. Joule 2025', doi:'https://osf.io/ju325/', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBqu1mPtw4hRbGcJpxnMxohAesvvTCFjojoGpkj0xa3ttI?e=fDVCd7', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  ...
  { id:'dataset_31', name:'Mendeley NMC811-LFP Relaxation', ref_name:'2023_Mendeley_NMC811-LFP_18650_Relaxation_MultiT', status:'pending', category:'eis', chemistry:'Multi', cells:'—', form:'18650', cycles:0, size_mb:1229, notes:'Auxiliary physical dataset: relaxation/rest voltage; NMC811+LFP; SOH estimation reference', doi:'https://data.mendeley.com/datasets/y8nstxmdrg/1', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgA-px8bByeZTZ6e6LK94owSAchC3h0mGXL0s9hy6KoAFS4?e=REJLlF', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  ...
  { id:'dataset_33', name:'TUM Thermal Runaway Propagation', ref_name:'2023_TUM_NMC811-LFP_Auto_ThermalRunaway_MultiT', status:'pending', category:'thermal_runaway', chemistry:'Multi', cells:'—', form:'Auto', cycles:0, size_mb:799, notes:'Auxiliary physical dataset: thermal runaway propagation; NMC-811+LFP automotive modules', doi:'https://mediatum.ub.tum.de/node?id=1717758', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgCOGktuuuDqSYXNk9xVkk62AdHPq7VHsekMzDC2kOEqgZU?e=lv9vSC', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_34', name:'Mendeley Mech-Induced Thermal Runaway', ref_name:'2023_Mendeley_LiIon_MechAbuse_NailPenetration_MultiT', status:'pending', category:'thermal_runaway', chemistry:'Unknown', cells:'—', form:'Multi', cycles:0, size_mb:276, notes:'Auxiliary physical dataset: mechanical abuse / nail penetration; thermal runaway trigger', doi:'https://data.mendeley.com/datasets/sn2kv34r4h/2', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBxqo5F5qKwQbH--4jPp3IpASRJpR9OyMGEu1SUu4mLSLw?e=Lhdp6u', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},
  { id:'dataset_35', name:'Zenodo ARC Calorimetry 21700', ref_name:'2023_Zenodo_NMC-NCA-LFP_21700_ARC_Calorimetry_MultiT', status:'pending', category:'thermal_runaway', chemistry:'Multi', cells:'55 specimens', form:'21700', cycles:0, size_mb:1, notes:'Auxiliary physical dataset: ARC exothermal; 21700; NMC/NCA/LFP; thermal safety', doi:'https://zenodo.org/records/7707929', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgBB_0fSJ5MXSbhmHVeJK6LyAYVORNLdvhuyyXT_3CkhohU?e=ONxPU5', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 55 ARC test specimens (complete release); cycling does not apply.', meta:'no',ts:'no',cs:'no',qc:'no',updated:'—'},

  { id:'dataset_36', name:'Imperial College 21700 Cycle Aging', ref_name:'2024_Imperial_Kirkaldy_NMC_21700_MultiC_MultiT', status:'done', category:'cycle_aging', chemistry:'NMC', cells:'40', form:'21700', cycles:131301, size_mb:47135, notes:'LG M50T/GBM50T 21700; 3 temps; J. Power Sources 2024', doi:'https://doi.org/10.5281/zenodo.10637534', processed_url:'https://entuedu-my.sharepoint.com/:f:/g/personal/hao-wang_staff_main_ntu_edu_sg/IgDFoGTyCAf7SokvWt55BZl9AXaoMW8HTT1L1p22T4Gc5zo?e=ReCV3T', evidence:'Full-dataset figures from the author documentation in the raw archives (checked 2026-09-08): 40 cells across the five experiments in experiment_metadata.xlsx (9 + 6 + 9 + 8 + 8); 131,301 aging cycles summed from the per-cell "Summary per Cycle" tables (complete 46 GB release held).', meta:'yes',ts:'yes',cs:'yes',qc:'no',updated:'2026/4/5'},
...
function computeHomeMetrics() {
  ...
  // Only plain cell counts contribute; entries measured in EVs or specimens are excluded.
  const cellsOf = d => /^[\d,]+$/.test(String(d.cells || '').trim()) ? parseInt(String(d.cells).replace(/,/g, ''), 10) || 0 : 0;
